...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (msg === "password-reset") setNotice("Your password has been updated. You can sign in now.");
    else if (msg === "check-email") setNotice("Check your email to confirm your account, then sign in.");
    else if (err === "auth-callback-failed") setError("Google sign-in didn't complete. Please try again.");
  }, []);
  ...
  const handleOAuth = async (provider: "google") => {
    ...
    // Clear any stale sign-up intent left by a previous register visit.
    document.cookie = "rd_oauth_intent=; path=/; max-age=0";
